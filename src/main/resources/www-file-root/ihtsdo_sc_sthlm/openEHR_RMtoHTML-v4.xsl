...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	version="2.0" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
	...
	<xsl:template name="ocean-observation-event-ITEM_STRUCTURE"
		...
		<xsl:choose>
			<xsl:when
				test="$itemsnode/v1:item or $itemsnode/v1:item[@xsi:type='ITEM_SINGLE']">&nbsp;
				<b>
					<xsl:call-template name="generic-DATA_VALUE">
			...
			<xsl:when
				test="$itemsnode/v1:item or $itemsnode/v1:item[@xsi:type='ITEM_TABLE']">
...
<!-- ***** BEGIN LICENSE BLOCK ***** - Version: MPL 1.1/GPL 2.0/LGPL 2.1 
	...
	License. - - The Original Code is - EhrView openEHR RM generic html transform 
	(base.xslt). - - The Initial Developer of the Original Code is - Ocean Informatics 
	Pty Ltd. - Portions created by the Initial Developer are Copyright (C) 2006-2008 
	- the Initial Developer. All Rights Reserved. - - Contributor(s): - Lisa 
	Thurston - Heath Frankel - - Alternatively, the contents of this file may 
	...
	or the GPL. If you do not delete - the provisions above, a recipient may 
