/**
 * Code heavily inspired by bunkat’s block #1962173 at http://bl.ocks.org/1962173
 */
...
function randomData() {
		...
		var generateRandomWorkItems = function () {
			var data = [];
			var laneCount = randomNumber(1,10)
			  , totalWorkItems = randomNumber(20,30)
			  , startMonth = randomNumber(0,10)
			  , startDay = randomNumber(1,28)
			  , totalMonths = randomNumber(1,12);
