// ISO-date-converter from http://webcloud.se/log/JavaScript-and-ISO-8601/
 ...
 Raphael.fn.timeband =  Raphael.fn.timeband || function(band_title, totalPixelWidth, lineHeight, lineSpacing, strokez, fill) {
	...
	// Print title
	var bandText = this.text(totalPixelWidth/2, lineHeight-15, this.band_title); // Todo: change to width of band
...
//		});
		...
		rect.node.onclick = function (){ console.log("clicked:" + text);console.log("link:" + popupLink);
			$.get(popupLink,
